...
class DocBlockrAtom {
  ...
  wrapLinesCommand (event) {
    ...
    const indentSpacesSamePara = ' '.repeat(this.editorSettings.indentation_spaces_same_para || numIndentSpaces);
  ...
  initialize (editor, inline) {
    ...
    this.indentSpaces = ' '.repeat(Math.max(0, this.editorSettings.indentation_spaces || 1));
