...
module.exports = class JsParser extends DocsParser {
  static settings = {
    ...
    fnOpener: 'function(?:\\s+[a-zA-Z_$][a-zA-Z_$0-9]*)?\\s*\\(',
    commentCloser: ' */',
    bool: 'Boolean',
    function: 'Function'
  };
  ...
  #comments = [
    {
      ...
      opener: '/*',
      closer: '*/',
      context: DocsParser.CONTEXT.BLOCK
    },
    {
      opener: '/**',
      closer: '*/',
      context: DocsParser.CONTEXT.BLOCK & DocsParser.CONTEXT.DOC
    },
    {
      opener: '//',
      context: DocsParser.CONTEXT.INLINE
    }
  ]
  ...
  static formatClass (name, superClass) {
    const out = [];
